...
<style>@-webkit-keyframes marqueeAnimation-5668783  { 100%  {margin-left:-1156px}}</style></head>
<body style="">
	...
	<%
		...
		String sql = "select TourCourseSequence,TourSiteTitle,TourSiteAddr,TourSiteFirstImage FROM tourcourse t, toursite site where t.TourSiteContentID = site.TourSiteContentID AND t.MemberID = ? order by TourCourseSequence ASC";
