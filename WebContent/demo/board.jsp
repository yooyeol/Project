...
<html>
<head>
<title>Express News a Entertainment Category Flat Bootstarp
	responsive Website Template | Fashion :: w3layouts</title>
...
<style>
@
-webkit-keyframes marqueeAnimation-1014259 { 100% {
	margin-left: -1103px
}

}
@
-webkit-keyframes marqueeAnimation-727834 { 100% {
	margin-left: -100905px
}

}
@
-webkit-keyframes marqueeAnimation-7580761 { 100% {
	margin-left: -100905px
}

}
@
-webkit-keyframes marqueeAnimation-3288690 { 100% {
	margin-left: -100905px
}

}
@
-webkit-keyframes marqueeAnimation-9751427 { 100% {
	margin-left: -100905px
}
}
</style>
...
<body style="">
					...
					<div class="wrap">
						...
						<div class="collapse navbar-collapse"
							...
							<ul class="nav navbar-nav">
								...
								<li class="dropdown"><a href="mypageMain.jsp"
									class="dropdown-toggle" data-toggle="dropdown"
									aria-expanded="false">마이페이지<b class="caret"></b></a>
	...
	<div class="wrap">
		<div class="move-text">
			...
			<div class="marquee">
				<div
					style="width: 100000px; margin-left: 905px; animation: marqueeAnimation-9751427 562.486s linear 1s infinite running;"
					...
					<div class="js-marquee" style="margin-right: 0px; float: left;">
						<div
							...
							<div class="js-marquee" style="margin-right: 0px; float: left;">
								<div class="marquee1">
									<a class="breaking" href="single.html">&gt;&gt;The standard
										chunk of Lorem Ipsum used since the 1500s is reproduced..</a>
								</div>
								<div class="marquee2">
									<a class="breaking" href="single.html">&gt;&gt;At vero eos
										et accusamus et iusto qui blanditiis praesentium voluptatum
										deleniti atque..</a>
								</div>
								<div class="clearfix"></div>
							</div>
